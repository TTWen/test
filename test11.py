...
# print ("Xtr.shape = ",Xtr.shape)    #(50000, 3072)
# print ("Xte.shape = ",Xte.shape)    #(10000, 3072)
# print ("Ytr.shape = ",Ytr.shape)    #(50000,)
# print ("Yte.shape = ",Yte.shape)    #(10000,)
# print ("type(Xtr) = ",type(Xtr))    #<class 'numpy.ndarray'>
...
def get_CIFAR10_data(num_training = 49000, num_validation = 1000, num_test = 1000, num_dev = 500):
    #加载原始cifar10数据
    X_train, y_train, X_test, y_test = load_CIFAR10(r"C:\Users\TTWen\Desktop\DesktopFile\Study\py\cifar-10-batches-py")
    ...
    print("mask:",mask)     #mask:[49000.49001,...,49999]
    X_val = X_train[mask]
    y_val = y_train[mask]
